  ...
  return (
    <section className="section-wrap pt-0">
      <div className="surface-panel overflow-hidden p-4 md:p-5">
        <p className="px-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-text-muted">
          Wall of Proof
        </p>
        <div className="mt-3 flex flex-wrap gap-2 md:flex-nowrap">
          {homeMetrics.map((metric) => (
            ...
            >
              <p className="font-heading text-xl tracking-[0.06em]">{metric.value}</p>
              <p className="mt-1 text-xs uppercase tracking-[0.14em] text-text-muted">{metric.label}</p>
